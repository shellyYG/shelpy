        ...
        >
          ...
          <div style={{ width: '80%', margin: 'auto', textAlign: 'start' }}>
            <div style={{ margin: '10px auto' }}>
              ...
              (註：最後收到的實際款項會略少於
              85%，是因為使用PayPal會有轉帳手續費的關係，由於 PayPal
              手續費多寡是視過來人帳號在哪個國家而定，無法事先預知，於是手續費目前由過來人自行吸收)。
              <br />
              2、 計算方式：依本公司公告費率為主。
              <br />
              3、 報酬發放日：每月 28 日，遇假日本公司可能提前或延後發放。
              <br />
              4、 報酬領取方式：每月 28 日，經由 PayPal 轉帳至過來人的 PayPal
              帳戶。
              <br />
              <br />
              <p style={{ fontSize: '16px', fontWeight: 'bold' }}>
