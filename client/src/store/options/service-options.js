...
export const countryOptions = [
  ...
  { value: 'Canada', label: 'country_canada' },
  ...
  { value: 'Norway', label: 'country_norway' },
  { value: 'Sweden', label: 'country_sweden' },
  { value: 'Finland', label: 'country_finland' },
  { value: 'Denmark', label: 'country_denmark' },
  { value: 'Ireland', label: 'country_ireland' },
  { value: 'Italy', label: 'country_italy' },
  { value: 'Netherland', label: 'country_netherland' },
  { value: 'Belgium', label: 'country_belgium' },
  { value: 'Luxembourg', label: 'country_luxembourg' },
  { value: 'Spain', label: 'country_spain' },
  { value: 'Portugal', label: 'country_portugal' },
  { value: 'Greece', label: 'country_greece' },
  { value: 'Vietnam', label: 'country_vietnam' },
  { value: 'Japan', label: 'country_japan' },
  { value: 'Korean', label: 'country_korea' },
  { value: 'Philippines', label: 'country_philippines' },
  { value: 'India', label: 'country_india' },
  { value: 'Nepal', label: 'country_nepal' },
  { value: 'Indonesia', label: 'country_indonesia' },
  { value: 'Malaysia', label: 'country_malaysia' },
  { value: 'Thailand', label: 'country_thailand' },
  { value: 'China', label: 'country_china' },
  { value: 'Turkey', label: 'country_turkey' },
  { value: 'Israle', label: 'country_israle' },
  { value: 'Lebanon', label: 'country_lebanon' },
  { value: 'Arabic', label: 'country_arabic' },
  { value: 'Ukraine', label: 'country_ukraine' },
  { value: 'Poland', label: 'country_poland' },
  { value: 'Romania', label: 'country_romania' },
  { value: 'Slovakia', label: 'country_slovakia' },
  { value: 'Croatia', label: 'country_croatia' },
  { value: 'Hungary', label: 'country_hungary' },
  { value: 'Czech Republic', label: 'country_czech' },
  { value: 'Lithuania', label: 'country_lithuania' },
  { value: 'Dubai', label: 'country_dubai' },
  { value: 'Monaco', label: 'country_monaco' },

  { value: 'Australia', label: 'country_australia' },
  { value: 'New Zealand', label: 'country_new_zealand' },
  { value: 'Mexico', label: 'country_mexico' },
  { value: 'Brazil', label: 'country_brazil' },
  { value: 'Columbia', label: 'country_columbia' },
  { value: 'Argentina', label: 'country_argentina' },
  { value: 'Peru', label: 'country_peru' },
  { value: 'Venezuela', label: 'country_venezuela' },
  { value: 'Chile', label: 'country_chile' },
  { value: 'Ecuador', label: 'country_ecuador' },

  { value: 'Nigeria', label: 'country_nigeria' },
  { value: 'Ethiopia', label: 'country_ethiopia' },
  { value: 'Egypt', label: 'country_egypt' },
  { value: 'Congo', label: 'country_congo' },
  { value: 'South Africa', label: 'country_south_africa' },
  { value: 'Tanzania', label: 'country_tanzania' },
  { value: 'Kenya', label: 'country_kenya' },
  { value: 'Algeria', label: 'country_algeria' },
  { value: 'Sudan', label: 'country_sudan' },
  { value: 'Morocco', label: 'country_morocco' },
  { value: 'Uganda', label: 'country_uganda' },
  { value: 'Others', label: othersText },
];
...
export const timeZoneOptions = [
  { value: 'default', label: 'please_select_option' },
  { value: 'gmt_minus_11', label: 'timeZone_gmt_minus_11' },
  { value: 'gmt_minus_10', label: 'timeZone_gmt_minus_10' },
  { value: 'gmt_minus_9', label: 'timeZone_gmt_minus_9' },
  { value: 'gmt_minus_8', label: 'timeZone_gmt_minus_8' },
  { value: 'gmt_minus_7', label: 'timeZone_gmt_minus_7' },
  { value: 'gmt_minus_6', label: 'timeZone_gmt_minus_6' },
  { value: 'gmt_minus_5', label: 'timeZone_gmt_minus_5' },
  { value: 'gmt_minus_4', label: 'timeZone_gmt_minus_4' },
  { value: 'gmt_minus_3', label: 'timeZone_gmt_minus_3' },
  { value: 'gmt_minus_2', label: 'timeZone_gmt_minus_2' },
  { value: 'gmt_minus_1', label: 'timeZone_gmt_minus_1' },
  { value: 'gmt_plus_0', label: 'timeZone_gmt_plus_0' },
  { value: 'gmt_plus_1', label: 'timeZone_gmt_plus_1' },
  { value: 'gmt_plus_2', label: 'timeZone_gmt_plus_2' },
  { value: 'gmt_plus_3', label: 'timeZone_gmt_plus_3' },
  { value: 'gmt_plus_4', label: 'timeZone_gmt_plus_4' },
  { value: 'gmt_plus_5', label: 'timeZone_gmt_plus_5' },
  { value: 'gmt_plus_6', label: 'timeZone_gmt_plus_6' },
  { value: 'gmt_plus_7', label: 'timeZone_gmt_plus_7' },
  { value: 'gmt_plus_8', label: 'timeZone_gmt_plus_8' },
  { value: 'gmt_plus_9', label: 'timeZone_gmt_plus_9' },
  { value: 'gmt_plus_10', label: 'timeZone_gmt_plus_10' },
  { value: 'gmt_plus_11', label: 'timeZone_gmt_plus_11' },
  { value: 'gmt_plus_12', label: 'timeZone_gmt_plus_12' },
  { value: 'gmt_plus_13', label: 'timeZone_gmt_plus_13' },
  { value: 'gmt_plus_14', label: 'timeZone_gmt_plus_14' },
];
